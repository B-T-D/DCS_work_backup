...
class Vector:
    ...
    def __eq__(self, vector2):
        """Return whether vector2 is equal to self."""
        # equal should mean equal in direction and magnitude, not super complex...
        return self._x == vector2._x and self._y == vector2._y
