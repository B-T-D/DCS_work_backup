...
from book's website http://discovercs.denison.edu/chapter9/"""
...
def main():
    columns = 50   # number of columns in the grid
...
##    grid = life(rows, columns, 200, glider, george)
    ...
    # exercise 9.2.1 coords
    a = [(1, 3), (2, 3), (3, 3), (3, 2), (2, 1)] # same as glider...
    b = [(9, 10), (10, 10), (11, 10)]
    c = columns - 5
    part_c = [(10, c + 1), (10, c + 4), (11, c), (12, c),
              (12, c + 4), (13, c), (13, c + 1), (13, c + 2),
              (13, c + 3)]
    r = rows // 2
    c = columns // 2
    part_d = [(r + 1, c + 2), (r + 2, c + 4), (r + 3, c + 1),
              (r + 3, c + 2), (r + 3, c + 5), (r + 3, c + 6),
              (r + 3, c + 7)]
    grid = life(rows, columns, 200, part_d, george)    
